    ...
    */
    ...
    if( $ack == "SUCCESS" || $ack == "SUCESSWITHWARNING") 
    {
        ...
        */
        ...
        $SHIPTOSTREET2=isset($resArray['SHIPTOSTREET2'])? $resArray['SHIPTOSTREET2'] : '';
        $SCity=$resArray['SHIPTOCITY'];
        $SState=$resArray['SHIPTOSTATE'];
        $SHIPTOZIP=$resArray['SHIPTOZIP'];
        $SHIPTOCOUNTRYCODE=$resArray['SHIPTOCOUNTRYCODE'];
        $SHIPTOCOUNTRYNAME=$resArray['SHIPTOCOUNTRYNAME'];
